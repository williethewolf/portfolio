...
export default function BrowserWindow({langWindowVis, setLangWindowVis, langSelected, height, width}) {
    ...
    <div className="absolute lg:left-[20%] bottom-[100px] lg:top-[20%] border-solid p-2 border-gray-300 bg-gray-300 shadow-[inset_-1px_-1px_2px_rgba(0,0,0,3)] w-6/6 xl:w-2/3  lg:h-5/6 xl:h-3/5 z-20 flex flex-col" ref={browserElementRef}>
        ...
        <div className="w-full bg-blue-800 text-white text-center flex justify-between"> 
          ...
          <div className="text-black flex justify-end"> 
            <button className="bg-gray-300 px-2 shadow-[inset_-1px_-1px_2px_rgba(0,0,0,1)]" onClick={() =>{setBrowserState("inactive")}}>-</button>
            <button className="bg-gray-300 px-2 shadow-[inset_-1px_-1px_2px_rgba(0,0,0,1)] disabled:opacity-50 disabled">❐</button>
            <button className="bg-gray-300 px-2 shadow-[inset_-1px_-1px_2px_rgba(0,0,0,1)]" onClick={() =>{setBrowserState("closed")}}>x </button>
          </div>
        </div>
        </section>
